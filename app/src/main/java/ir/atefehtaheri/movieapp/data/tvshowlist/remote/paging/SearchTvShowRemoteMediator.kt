...
class SearchTvShowRemoteMediator @Inject constructor(
    private val tvShowsDatasource: TvShowsDatasource,
    private val movieDatabase: MovieDatabase,
    private val query: String,
    private val type: Type = Type.TvShow,
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val networkResponse = tvShowsDatasource.getSearchTvShowPager(query, page)
